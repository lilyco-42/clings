## Lesson 31 - ll 和 date (ls -l 命令实现)

### 课程任务

1. 实现 Linux 下 ls -l 命令的基本功能，要求能够支持以下三个参数。
   - -i 在输出行中显示 inode 节点号
   - -s 显示每个文件占用的块数
...
2. 实现 date 命令，显示当前时间。
   ...
   $ date
   2014 年 1 月 22 日 星期三 14 时 07 分 31 秒 PST
...
- [linux stat 函数讲解](http://www.cnblogs.com/hnrainll/archive/2011/05/11/2043361.html)
