## Lesson 29 - more command (more 命令实现)

### 课程任务

实现 Linux 下 more 命令的基本功能，要求能够支持以下四个快捷键。
...
- 自己编写 more 命令 http://www.cnblogs.com/zhangchaoyang/articles/2293910.html

### 重要知识点

- 学习内存动态分配函数 malloc
- 加强对于指针变量的管理和使用
- 了解 Linux 关于终端 tty 的配置和编程
