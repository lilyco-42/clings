...
- 从起点开始拓展边 (u,v) 如果 d[v] > d[u] + w(u,v) 则更新 d[v]
- 更新 d[v]的同时，记录 v 的前驱点，以便未来能够回溯出最短路径
- 起点所在的集合为 S，保留我们已知 d[v]的值是最短路径的顶点集合
- 其他所有点的集合为 Q，每次遍历都有一个顶点从 Q 移动到 S，这个被选择的顶点是 Q 中拥有最小的 d[u]值的顶点
