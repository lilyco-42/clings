...
static void gen_expr(Node *node)
{
    ...
    if (node->kind == ND_VAR_DECL) {
        if (node->lhs) {
            gen_expr(node->lhs);
            store_local("a0", node->var->offset,
    ...
    switch (node->kind) {
    case ND_ADD: printf("    add a0, a0, t0\n"); break;
    case ND_SUB: printf("    sub a0, a0, t0\n"); break;
    case ND_MUL: printf("    mul a0, a0, t0\n"); break;
    case ND_DIV: printf("    div a0, a0, t0\n"); break;
    case ND_MOD: printf("    rem a0, a0, t0\n"); break;
    case ND_BITAND: printf("    and a0, a0, t0\n"); break;
    case ND_BITOR:  printf("    or a0, a0, t0\n"); break;
    case ND_BITXOR: printf("    xor a0, a0, t0\n"); break;
    case ND_SHL: printf("    sll a0, a0, t0\n"); break;
    case ND_SHR: printf("    sra a0, a0, t0\n"); break;
    case ND_EQ:
        printf("    sub a0, a0, t0\n");
        printf("    seqz a0, a0\n");
        break;
    case ND_NE:
        ...
        printf("    snez a0, a0\n");
        break;
    case ND_LT:  printf("    slt a0, a0, t0\n"); break;
    case ND_LE:
        printf("    slt a0, t0, a0\n");
        printf("    xori a0, a0, 1\n");
        break;
    case ND_GT:  printf("    slt a0, t0, a0\n"); break;
    case ND_GE:
        printf("    slt a0, a0, t0\n");
        printf("    xori a0, a0, 1\n");
        break;
