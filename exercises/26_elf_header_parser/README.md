## Lesson 26 - ELF Header Parser (ELF 文件头分析器实现)
...
- 在完成上述功能的基础上，能够区分 .o .so .elf 这 3 种文件属性，实现 file 命令的部分功能。
...
- [ELF 文件简介](http://learn.akae.cn/media/ch18s05.html)
...
- [elf 文件格式详解](http://blog.chinaunix.net/attachment/attach/26/40/46/9726404697228d82cda2af11366fa7722d3a4f1a58.pdf)

- [格式化 I/O 函数](http://learn.akae.cn/media/ch25s02.html#id2832755)
...
- [《unix 编程艺术》策略同机制分离，接口同引擎分离](http://www.cnblogs.com/chgaowei/archive/2011/07/26/2117644.html)
